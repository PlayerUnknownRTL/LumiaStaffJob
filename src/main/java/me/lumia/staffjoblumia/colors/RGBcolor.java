package me.lumia.staffjoblumia.colors;
...
public class RGBcolor {
    ...
    public static class RGBcolors {
        ...
        /**
         * Преобразует строку с HEX-кодами и градиентами в цветной текст Minecraft.
         */
        ...
        /**
         * Преобразует строку в Adventure `Component` с цветами и градиентами.
         */
        ...
        /**
         * Создает градиентный текст (HEX-коды заменяются на `§x` формат).
         */
        private static String applyGradient(String startColor, String endColor, String text) {
            ...
            StringBuilder gradientText = new StringBuilder(length * 14); // Каждая буква кодируется в ~14 символов
        ...
        /**
         * Заменяет `&` на `§` в цветовых кодах Minecraft.
         */
